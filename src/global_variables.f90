...
abstract interface 
  subroutine get_grain_temperature_interface(time, gastemperature, av, grain_temperature)
  import
...
! 1D arrays
allocate(dust_temperature(nb_grains))
dust_temperature(1:nb_grains) = 0.d0
